...
{
  fprintf(stderr, "Usage: djpeg [switches] inputfile outputfile\n");
  fprintf(stderr, "Optional switches:\n");
#ifdef GIF_SUPPORTED
  fprintf(stderr, "  -G          Select GIF output, extension .GIF\n");
#endif
#ifdef PPM_SUPPORTED
  fprintf(stderr, "  -P          Select PPM/PGM output, extension .PPM (default)\n");
#endif
#ifdef RLE_SUPPORTED
  ...
  fprintf(stderr, "  -m memory   Maximum memory to use (default infinite); see USAGE\n");
#endif
